...
get.on('click', () => {
	Janus.init({debug: "all", callback: function() {
        get.attr('disabled', true).unbind('click');
            ...
            success: function() {
                ...
                janus.attach({
                    ...
                    success: function(pluginHandle) {
                        ...
                        $('#audio-login').removeClass('hide').show();
                        $('#signin').removeClass('hide').show();
                        $('#signup').removeClass('hide').show();
                        $('#do-signin').click(doLogin);
                        $('#do-signup').click(registerUsername);
                        // $('#username').focus();
                        $('#start-app').removeAttr('disabled').html("Leave").click(function() {
                    ...
                    onmessage: function(msg, jsep) {
                        ...
                        if (event) {
                            if (event === "joined") {
                                ...
                                $(`#room-${myroom}`).removeClass('active');
                                $(`#room-${msg["room"]}`).addClass('active');
                                myroom = msg["room"];
                                ...
                                window.electron.doLogout(myusername);
                            } else if (event === "event") {
                                if(msg["participants"]) {
                                    var list = msg["participants"];
                                    Janus.debug("Got a list of participants:", list);
